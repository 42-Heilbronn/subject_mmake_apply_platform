...
\multicolumn{1}{|c|}{\normalsize Exercise 00} \\
\hline
\multicolumn{2}{|c|}{\normalsize rush-02} \tabularnewline
\hline
\multicolumn{2}{|l|}{\normalsize Turn-in directory : ex00/} \tabularnewline
\hline
\multicolumn{2}{|l|}{\normalsize Files to turn in : Makefile and all the necessary files} \tabularnewline
\hline
\multicolumn{2}{|l|}{\normalsize Allowed functions : All functions of the 'connection' library} \tabularnewline
\hline
\end{tabular}
}
