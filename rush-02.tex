...
\begin{itemize}
  ...
  \item Name your bot team name after your team lead's intra name (don't mess this up).
  ...
  \begin{itemize}
    \item Go to the \href{https://coregame.de}{coregame.de} website (login with your GitHub).
    ...
    \item Open your browser at \texttt{localhost}.
    \item Have fun!
  \end{itemize}
